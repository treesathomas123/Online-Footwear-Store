"""
Django settings for FootLand project.
...
SECRET_KEY = 'django-insecure-6w4t3!p8iy(w)bua2@d5zo(xp8wr4bv_-24e_=n9x=$go6cu-='
...
WSGI_APPLICATION = 'FootLand.wsgi.application'
